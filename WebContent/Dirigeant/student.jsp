...
<!-- Head Begin -->
<head>
  <title>Soutien Scolaire | Élèves</title>
	...
	<div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <h2 class="text-center display-6">Élèves</h2>
	        <p class="text-muted text-center">Ajoutez et modifiez vos élèves et téléchargez leurs documents</p>
	      </div>
	      <!-- /.container-fluid -->
	    </section>
					                    ...
					                    <div class="col-12">
					                        <div class="row">
					                            ...
					                            <div class="col-3 pull-right">
					                            	<div class="btn-group-sm">
									                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Ajouter un étudiant</button>
									                  <div class="dropdown-menu" role="menu">
									                    <a class="dropdown-item" href="./addStudent.jsp">Créer un nouvel étudiant</a>
				                ...
				                <table class="table table-bordered">
				                  <thead>
				                    <tr>
				                      ...
				                      <th>E-mail</th>
				                      <th>Formation</th>
				                      <th style="width: 40px">Présence</th>
				                    </tr>
				                  </thead>
