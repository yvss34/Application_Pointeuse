                ...
                <div class="form-content">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Prenom *" id="prenom" name="prenom" value="" size="20" maxlength="20" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" id="email" class="form-control" placeholder="Email *" name="email" value="" size="20" maxlength="20" />
                                <span class="erreur" style="color:red">${form.erreurs['email']}</span>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Mot de passe *" id="motdepasse" name="motdepasse" value="" size="20" maxlength="20" />
                            	<span class="erreur" style="color:red">${form.erreurs['motdepasse']}</span>
                            </div>
                        </div>
                    </div>
