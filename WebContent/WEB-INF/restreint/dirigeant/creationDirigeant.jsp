...
<head>
<meta charset="utf-8" />
<title>Creation Dirigeant</title>
...
<body>
	...
	<div class="container register-form">
		<form method="post" action="CreationDirigeant">
			<div class="note">
				<p>Ajouter un dirigeant</p>
			</div>
	...
	<a
		href="http://localhost:8080/Projet_Libre_Application_Pointeuse/Dirigeant">Retourner
		au menu principal</a>
</body>
</html>